        ...
        <div className="fixed inset-0 backdrop-blur-md bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Approve Blood Bank Post</h3>
            </div>
            
            <p className="text-gray-600 mb-6">
              Are you sure you want to approve <strong>"{postToAction.departmentName}"</strong>? 
              This will make the blood bank post publicly visible.
            </p>
        ...
        <div className="fixed inset-0 backdrop-blur-md bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Delete Blood Bank Post</h3>
            </div>
